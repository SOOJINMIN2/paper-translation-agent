...
# ── Gemini 모델 설정 ──────────────────────────────────────────────
HIGH_PRIORITY_MODEL = os.environ.get("HIGH_PRIORITY_MODEL", "gemini-2.0-flash-lite")
LOW_PRIORITY_MODEL  = os.environ.get("LOW_PRIORITY_MODEL",  "gemini-2.0-flash-lite")
VISION_MODEL        = os.environ.get("VISION_MODEL",        "gemini-2.0-flash-lite")
